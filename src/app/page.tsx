...
const EXPERIENCIA = [
  { year: '2025 — ACTUAL', title: 'Ingeniería Informática', company: 'Formación universitaria', description: 'Formación enfocada en programación, desarrollo de software, estructuras de datos y creación de soluciones tecnológicas.' },
  { year: '2025 — ACTUAL', title: 'Análisis y Desarrollo de Software', company: 'Formación tecnológica', description: 'Formación orientada al desarrollo de aplicaciones, programación, bases de datos, desarrollo web y construcción de soluciones de software.' },
  { year: '2025 — 2026', title: 'Calma', company: 'Proyecto personal — Finalizado', description: 'Aplicación enfocada en acompañamiento y bienestar, desarrollada como proyecto tecnológico con una experiencia de interacción mediante chatbot.' },
  { year: '2025 — ACTUAL', title: 'Sistema de Asistencia QR', company: 'Proyecto académico — En desarrollo', description: 'Sistema de asistencia mediante códigos QR con validación por horario y distancia, registro de asistencias y control de información.' },
];

const TECNOLOGIAS = [
  { categoria: 'DESARROLLO WEB', elementos: [{ nombre: 'HTML5', codigo: 'HTML' }, { nombre: 'CSS3', codigo: 'CSS' }, { nombre: 'JavaScript', codigo: 'JS' }, { nombre: 'TypeScript', codigo: 'TS' }, { nombre: 'React', codigo: 'RE' }, { nombre: 'Next.js', codigo: 'NX' }, { nombre: 'Tailwind CSS', codigo: 'TW' }] },
  { categoria: 'PROGRAMACIÓN Y SERVIDOR', elementos: [{ nombre: 'Java', codigo: 'JV' }, { nombre: 'Python', codigo: 'PY' }, { nombre: 'Node.js', codigo: 'ND' }, { nombre: 'PHP', codigo: 'PHP' }] },
  { categoria: 'DESARROLLO MÓVIL', elementos: [{ nombre: 'Flutter', codigo: 'FL' }, { nombre: 'Dart', codigo: 'DT' }] },
  { categoria: 'BASES DE DATOS', elementos: [{ nombre: 'MySQL', codigo: 'MY' }, { nombre: 'PostgreSQL', codigo: 'PG' }, { nombre: 'MongoDB', codigo: 'MG' }, { nombre: 'SQL', codigo: 'SQL' }] },
  { categoria: 'SERVICIOS Y HERRAMIENTAS', elementos: [{ nombre: 'Appwrite', codigo: 'AW' }, { nombre: 'Firebase', codigo: 'FB' }, { nombre: 'Docker', codigo: 'DK' }, { nombre: 'Git', codigo: 'GT' }] },
];

const PROYECTOS = [
  { numero: '01', titulo: 'CALMA', estado: '✅ PROYECTO FINALIZADO', descripcion: 'Aplicación enfocada en acompañamiento y bienestar con una experiencia de interacción mediante chatbot.', tecnologias: ['TypeScript', 'React', 'Next.js', 'Appwrite'], visual: 'calma', repo: null as string | null, demo: null as string | null },
  { numero: '02', titulo: 'PORTAFOLIO PERSONAL', estado: '✅ PROYECTO ACTIVO', descripcion: 'Portafolio web con una experiencia interactiva que muestra mi formación, tecnologías, proyectos y evolución como desarrollador.', tecnologias: ['TypeScript', 'Next.js', 'Tailwind CSS', 'Appwrite'], visual: 'portfolio', repo: 'https://github.com/santiagoaguirre66415/santiago-platform', demo: 'https://sanas07a.dev' },
  { numero: '03', titulo: 'SISTEMA DE ASISTENCIA QR', estado: '🚧 PROYECTO EN DESARROLLO', descripcion: 'Sistema de asistencia mediante códigos QR con validación de horario y distancia para realizar registros de forma más precisa.', tecnologias: ['JavaScript', 'React', 'Node.js', 'SQL'], visual: 'qr', repo: null as string | null, demo: null as string | null },
  { numero: '04', titulo: 'PROYECTOS DE FORMACIÓN', estado: '📚 PROCESO DE APRENDIZAJE', descripcion: 'Conjunto de ejercicios y proyectos desarrollados durante mi proceso de formación en programación y desarrollo de software.', tecnologias: ['Python', 'Java', 'Flutter', 'SQL'], visual: 'codigo', repo: null as string | null, demo: null as string | null },
];
    ...
    return (
      <div className="pantalla-proyecto">
        <div className="barra-navegador">
          <span className="punto-navegador" /><span className="punto-navegador" /><span className="punto-navegador" />
          <span className="direccion-navegador">calma</span>
        </div>
        <div className="contenido-calma">
          <div className="menu-calma">
            <div className="logo-calma">C</div><span /><span /><span /><span />
          </div>
          <div className="principal-calma">
            ...
            <div className="tarjetas-mockup"><div /><div /><div /></div>
          </div>
        </div>
      </div>
    );
      ...
      <div className="pantalla-proyecto">
        ...
        <div className="contenido-qr">
          <div className="contenedor-qr">
            <div className="codigo-qr"><i /><i /><i /><i /><i /><i /><i /><i /><i /></div>
          ...
          <div className="informacion-qr">
            ...
            <div className="fila-asistencia"><span>Horario</span><b>08:00 — 10:00</b></div>
            <div className="fila-asistencia"><span>Distancia</span><b>VALIDADA</b></div>
          </div>
        </div>
      </div>
    );
    ...
    return (
      <div className="pantalla-proyecto">
        ...
        <div className="visual-portafolio">
          ...
          <div className="titulo-portafolio">SANTIAGO<br />AGUIRRE</div>
          <div className="linea-portafolio" />
          <div className="datos-portafolio"><span>DESARROLLO FULL STACK</span><span>2026</span></div>
        </div>
      </div>
    );
  }
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    setXp(data.xp);
    setNivelesDesbloqueados(data.nivelesHome);
    setLogrosDesbloqueados(data.logrosHome);
    setHydrated(true);
  }, []);
  ...
  useEffect(() => {
    ...
    saveProgress({
      ...data,
      xp,
      nivelesHome: nivelesDesbloqueados,
      logrosHome: logrosDesbloqueados,
    });
  }, [xp, nivelesDesbloqueados, logrosDesbloqueados, hydrated]);
    ...
    <main id="main-content" className="min-h-screen overflow-hidden bg-[#08090b] text-white">
      ...
      <div className="fixed bottom-6 left-6 z-50 hidden w-[250px] md:block">
        <div className="border border-white/10 bg-[#0b0d10]/90 p-4 backdrop-blur-xl">
          <div className="mb-3 flex items-center justify-between">
            <span className="text-[10px] font-semibold tracking-[0.25em] text-white/40">PROGRESO</span>
            <span className="font-mono text-xs text-red-500">NIVEL {String(nivelActual).padStart(2, '0')}</span>
          </div>
        ...
        <div className="mx-auto grid w-full max-w-7xl gap-10 sm:gap-16 lg:grid-cols-[1.25fr_.75fr] lg:items-center">
          <div>
            <div className="mb-6 flex items-center gap-3 sm:mb-8 sm:gap-4">
              ...
              <span className="font-mono text-[8px] font-semibold tracking-[0.3em] text-red-500 sm:text-[10px] sm:tracking-[0.35em]">PORTAFOLIO / 2025 — ACTUAL</span>
            </div>
            ...
            <h1 className="max-w-5xl text-[clamp(2.5rem,14vw,9.5rem)] font-black leading-[0.85] tracking-[-0.05em] sm:leading-[0.8] sm:tracking-[-0.07em]">
              SANTIAGO<br /><span className="text-white/20">AGUIRRE</span>
            </h1>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:mt-10 sm:flex-row sm:items-center sm:gap-5">
              <div className="border-l border-red-600 pl-3 sm:pl-4">
                <p className="text-xs font-semibold tracking-[0.15em] text-white sm:text-sm sm:tracking-[0.18em]">DESARROLLADOR FULL STACK</p>
                <p className="mt-1 text-[10px] tracking-[0.18em] text-white/35 sm:text-xs sm:tracking-[0.2em]">EN FORMACIÓN</p>
              </div>
              <div className="hidden h-8 w-px bg-white/10 sm:block" />
              <p className="max-w-md text-xs leading-6 text-white/45 sm:text-sm">Construyo interfaces, exploro nuevas tecnologías y convierto ideas en proyectos funcionales.</p>
            </div>

            <div className="mt-8 flex flex-col gap-3 sm:mt-12 sm:flex-row sm:flex-wrap">
              <a href="#nivel-5" className="group flex items-center justify-center gap-3 border border-red-600 bg-red-600 px-5 py-3 text-[10px] font-bold tracking-[0.15em] transition-all hover:bg-red-500 sm:px-6 sm:text-xs sm:tracking-[0.18em]">
                VER PROYECTOS <span className="transition-transform group-hover:translate-x-1">→</span>
              </a>
              <a href="https://www.linkedin.com/in/tu-linkedin" target="_blank" rel="noopener noreferrer" className="border border-white/10 px-5 py-3 text-center text-[10px] font-bold tracking-[0.15em] text-white/70 transition-all hover:border-white/30 hover:text-white sm:px-6 sm:text-xs sm:tracking-[0.18em]">LINKEDIN</a>
              <a href="/cv.pdf" target="_blank" rel="noopener noreferrer" className="border border-white/10 px-5 py-3 text-center text-[10px] font-bold tracking-[0.15em] text-white/70 transition-all hover:border-white/30 hover:text-white sm:px-6 sm:text-xs sm:tracking-[0.18em]">CV</a>
              <a href="mailto:santiago.aguirre66415@ucaldas.edu.co" className="border border-white/10 px-5 py-3 text-center text-[10px] font-bold tracking-[0.15em] text-white/70 transition-all hover:border-white/30 hover:text-white sm:px-6 sm:text-xs sm:tracking-[0.18em]">CONTACTO</a>
            </div>
          </div>
          ...
          <div className="relative hidden lg:block">
            <div className="relative aspect-square border border-white/10 bg-[#0c0e11]/70 p-8">
              ...
              <div className="absolute left-8 top-8 font-mono text-[9px] tracking-[0.25em] text-white/25">MANIZALES / COLOMBIA</div>
              <div className="absolute bottom-8 right-8 font-mono text-[9px] tracking-[0.25em] text-white/25">05 / 05</div>
      ...
      <section className="relative z-10 border-y border-white/10 bg-[#0a0c0f]/80 px-4 py-10 backdrop-blur-xl sm:px-6 md:px-12">
        <div className="mx-auto max-w-7xl">
          <div className="mb-8 flex items-end justify-between">
            ...
            <span className="font-mono text-[10px] text-white/25">{String(nivelActual).padStart(2, '0')} / 05</span>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-5">
            {NIVELES.map((nivel) => {
              ...
              return (
                <div key={nivel.nivel} className={`group relative border p-3 transition-all sm:p-4 ${desbloqueado ? 'border-white/10 bg-white/[0.025]' : 'border-white/[0.05] bg-black/20 opacity-40'} ${activo ? 'border-red-600/60' : ''}`}>
                  {activo && <div className="absolute left-0 top-0 h-px w-full bg-red-600" />}
                  <div className="flex items-center justify-between">
                    <span className={`font-mono text-base font-bold sm:text-lg ${activo ? 'text-red-500' : 'text-white/40'}`}>0{nivel.nivel}</span>
                    <span className="text-[8px] tracking-widest text-white/20 sm:text-[9px]">{desbloqueado ? 'ABIERTO' : 'BLOQ.'}</span>
                  </div>
                  <div className="mt-4 text-[9px] font-bold tracking-[0.15em] text-white/70 sm:mt-5 sm:text-[10px]">{nivel.titulo}</div>
                  <div className="mt-1 text-[8px] text-white/25 sm:text-[9px]">{nivel.subtitulo}</div>
                </div>
              );
            })}
          </div>
        ...
        <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 md:px-12 md:py-32 lg:px-20">
          <div className="grid gap-8 sm:gap-12 lg:grid-cols-[280px_1fr] lg:gap-16">
            ...
            <div className="max-w-3xl">
              <p className="text-xl font-medium leading-relaxed text-white/85 sm:text-2xl md:text-4xl md:leading-tight">Soy Santiago Aguirre, desarrollador Full Stack en formación desde Manizales, Colombia.</p>
              <p className="mt-6 max-w-2xl text-sm leading-7 text-white/40 sm:mt-8 sm:text-base sm:leading-8">Actualmente estoy construyendo mi camino en el desarrollo de software mediante formación académica, proyectos personales y experimentación constante con nuevas tecnologías.</p>
              <div className="mt-8 grid grid-cols-2 gap-px border border-white/10 bg-white/10 sm:mt-12 sm:grid-cols-4">
                {[['2025', 'INICIO'], ['CO', 'UBICACIÓN'], ['01', 'PERFIL'], ['∞', 'APRENDIZAJE']].map(([valor, etiqueta]) => (
          ...
          <div className="grid gap-8 sm:gap-12 lg:grid-cols-[280px_1fr] lg:gap-16">
            ...
            <div>
              <div className="mb-8 border border-red-600/20 bg-red-600/[0.03] p-5 sm:mb-10 sm:p-6">
                ...
                <p className="mt-4 max-w-2xl text-sm leading-7 text-white/50">Actualmente no cuento con experiencia laboral profesional. Mi experiencia se ha desarrollado principalmente mediante formación académica, proyectos personales y proyectos de desarrollo.</p>
              </div>
        ...
        <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 md:px-12 md:py-32 lg:px-20">
          <div className="grid gap-8 sm:gap-12 lg:grid-cols-[280px_1fr] lg:gap-16">
            <div>
              ...
              <p className="mt-4 text-sm leading-7 text-white/30 sm:mt-6">Tecnologías que forman parte de mi proceso de aprendizaje y desarrollo.</p>
            </div>
                ...
                <div key={grupo.categoria}>
                  ...
                  <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-4">
                    {grupo.elementos.map((tecnologia) => (
                      <div key={tecnologia.nombre} className="group flex items-center gap-3 border border-white/10 bg-white/[0.02] p-3 transition-all hover:-translate-y-1 hover:border-red-600/40 hover:bg-white/[0.04] sm:gap-4 sm:p-4">
                        <div className="flex h-9 w-9 shrink-0 items-center justify-center border border-white/10 bg-[#101216] font-mono text-[8px] font-bold text-white/60 transition-colors group-hover:border-red-600/40 group-hover:text-red-500 sm:h-10 sm:w-10 sm:text-[9px]">{tecnologia.codigo}</div>
        ...
        <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 md:px-12 md:py-32 lg:px-20">
          <div className="mb-12 sm:mb-16">
            ...
            <div className="mt-2 flex flex-col justify-between gap-3 md:flex-row md:items-end md:gap-5">
              ...
              <p className="max-w-md text-sm leading-6 text-white/30">Una selección de proyectos desarrollados durante mi proceso de formación.</p>
            </div>
          </div>

          <div className="grid gap-6 lg:grid-cols-2">
            {PROYECTOS.map((proyecto) => (
              <article key={proyecto.numero} className="group overflow-hidden border border-white/10 bg-[#0b0d10] transition-all duration-500 hover:-translate-y-1 hover:border-white/20">
                <div className="relative overflow-hidden border-b border-white/10">
                  <VisualProyecto tipo={proyecto.visual} />
                  <div className="absolute left-4 top-4 border border-white/10 bg-[#08090b]/80 px-3 py-2 font-mono text-[9px] tracking-[0.2em] text-white/40 backdrop-blur sm:left-5 sm:top-5">{proyecto.numero}</div>
                </div>
                ...
                <div className="p-5 sm:p-7">
                  ...
                  <div className="mt-6 flex flex-wrap gap-2">
                    {proyecto.tecnologias.map((tecnologia) => (
                      <span key={tecnologia} className="border border-white/10 px-3 py-1.5 font-mono text-[8px] tracking-wider text-white/30">{tecnologia}</span>
                    ))}
                  </div>
                  ...
                  {(proyecto.repo || proyecto.demo) && (
                    <div className="mt-6 flex flex-wrap gap-3 border-t border-white/10 pt-5">
                      {proyecto.demo && (
                        <a href={proyecto.demo} target="_blank" rel="noopener noreferrer" className="group/link flex items-center gap-2 border border-red-600/40 bg-red-600/10 px-4 py-2 font-mono text-[9px] tracking-[0.2em] text-red-300 transition hover:bg-red-600/20">
                          DEMO <span className="transition-transform group-hover/link:translate-x-1">→</span>
                        </a>
                      )}
                      {proyecto.repo && (
                        <a href={proyecto.repo} target="_blank" rel="noopener noreferrer" className="group/link flex items-center gap-2 border border-white/15 bg-white/[0.02] px-4 py-2 font-mono text-[9px] tracking-[0.2em] text-white/60 transition hover:bg-white/[0.05] hover:text-white">
                          CÓDIGO <span className="transition-transform group-hover/link:translate-x-1">→</span>
                        </a>
                      )}
                    </div>
                  )}
      ...
      <section className="relative z-10 border-t border-white/10 bg-[#090a0c]">
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 md:px-12 md:py-32 lg:px-20">
          <div className="mb-10 flex flex-col justify-between gap-5 sm:mb-14 md:flex-row md:items-end">
            ...
            <button onClick={reiniciarProgreso} className="self-start border border-white/10 px-4 py-2 font-mono text-[8px] tracking-[0.2em] text-white/25 transition-colors hover:border-red-600/40 hover:text-red-500">REINICIAR PROGRESO</button>
          </div>

          <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
            {LOGROS.map((logro, indice) => (
              <div key={logro.id} onMouseEnter={() => desbloquearLogro(indice + 1)} className="cursor-default">
                <AchievementCard icon={logro.id} title={logro.titulo} description={logro.descripcion} unlocked={logrosDesbloqueados.includes(indice + 1)} xp={logro.xp} />
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-10 lg:grid-cols-[1fr_1fr] lg:items-end lg:gap-16">
            <div>
              ...
              <h2 className="mt-5 max-w-xl text-4xl font-black tracking-[-0.05em] sm:text-5xl md:text-7xl">SIEMPRE<br /><span className="text-white/20">CONSTRUYENDO.</span></h2>
            </div>
            <div className="grid gap-px border border-white/10 bg-white/10">
              {['Profundizar en desarrollo Full Stack', 'Construir proyectos más completos', 'Mejorar arquitectura y bases de datos', 'Continuar explorando nuevas tecnologías'].map((objetivo, indice) => (
      ...
      <section className="relative z-10 overflow-hidden border-t border-white/10 bg-[#0b0d10]">
        ...
        <div className="relative mx-auto max-w-5xl px-4 py-20 text-center sm:px-6 sm:py-24 md:py-32">
          ...
          <h2 className="mx-auto mt-6 max-w-4xl text-4xl font-black tracking-[-0.06em] sm:mt-7 sm:text-5xl md:text-8xl">CONSTRUYAMOS<br /><span className="text-white/20">ALGO JUNTOS.</span></h2>
          <p className="mx-auto mt-6 max-w-xl text-sm leading-7 text-white/35 sm:mt-8">¿Tienes una idea, proyecto o simplemente quieres hablar de tecnología? Estoy abierto a nuevas oportunidades para aprender y construir.</p>
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:mt-10 sm:flex-row sm:flex-wrap">
            <a href="mailto:santiago.aguirre66415@ucaldas.edu.co" className="w-full border border-red-600 bg-red-600 px-7 py-3 text-xs font-bold tracking-[0.2em] transition hover:bg-red-500 sm:w-auto">ESCRIBIRME</a>
            <a href="https://github.com/santiagoaguirre66415" target="_blank" rel="noreferrer" className="w-full border border-white/10 px-7 py-3 text-xs font-bold tracking-[0.2em] text-white/60 transition hover:border-white/30 hover:text-white sm:w-auto">GITHUB</a>
            <a href="https://www.linkedin.com/in/tu-linkedin" target="_blank" rel="noreferrer" className="w-full border border-white/10 px-7 py-3 text-xs font-bold tracking-[0.2em] text-white/60 transition hover:border-white/30 hover:text-white sm:w-auto">LINKEDIN</a>
            <a href="/cv.pdf" target="_blank" rel="noreferrer" className="w-full border border-white/10 px-7 py-3 text-xs font-bold tracking-[0.2em] text-white/60 transition hover:border-white/30 hover:text-white sm:w-auto">CV</a>
          </div>
        </div>
      </section>
